...
1. [conceptos-imagen-contenedor-orquestacion.md](conceptos-imagen-contenedor-orquestacion.md)
2. [operativa-basica-de-contenedores.md](operativa-basica-de-contenedores.md)
3. [interaccion-con-anfitrion-volumenes-puertos-env.md](interaccion-con-anfitrion-volumenes-puertos-env.md)
4. [dockerfile-y-personalizacion-de-imagenes.md](dockerfile-y-personalizacion-de-imagenes.md)
5. [orquestacion-con-docker-compose.md](orquestacion-con-docker-compose.md)
6. [entornos-de-desarrollo-contenorizados.md](entornos-de-desarrollo-contenorizados.md)

---

# LABORATORIO

Directorio: `labs/01-docker-basico/laboratorio/`

1. [step-01-ejecutar-y-listar-contenedores.md](laboratorio/step-01-ejecutar-y-listar-contenedores.md)
2. [step-02-interactividad-volumenes-puertos.md](laboratorio/step-02-interactividad-volumenes-puertos.md)
3. [step-03-dockerfile-build-compose.md](laboratorio/step-03-dockerfile-build-compose.md)
